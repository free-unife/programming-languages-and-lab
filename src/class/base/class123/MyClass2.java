...
public class MyClass2 //E' come il main del C; cambiato il nome della classe...
{
	public static void main(String args[]) //Questo e' il vero main. Si sta dicendo che la funzione main e' un metodo della classe. Classe e' un insieme. Un metodo e' statico, cioe' ha proprietà statiche.
	{
		...
		if(args.length>0) //Controllo se ho passato un qualche parametro da terminale. Cioe' se la len e' maggiore di zero
			System.out.println(args[0]); //Questa e' una API, al contrario del C nel quale vengono usate poco.
	}
}
//####Istruzioni####
